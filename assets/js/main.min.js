! function(e, t) {
    ...
    function l(e, t, n, r) {
        var i, o = 1,
            ...
            c = (oe.cssNumber[t] || "px" !== l && +u) && Ie.exec(oe.css(e, t));
        if (c && c[3] !== l) {
            l = l || c[3], n = n || [], c = +u || 1;
    ...
    function d(e, t, n, r, i) {
        for (var o, a, s, u, l, d, p = t.createDocumentFragment(), h = [], m = 0, g = e.length; g > m; m++)
            if (o = e[m], o || 0 === o)
                if ("object" === oe.type(o)) oe.merge(h, o.nodeType ? [o] : o);
                else if (Me.test(o)) {
            for (a = a || p.appendChild(t.createElement("div")), s = (Oe.exec(o) || ["", ""])[1].toLowerCase(), u = qe[s] || qe._default, a.innerHTML = u[1] + oe.htmlPrefilter(o) + u[2], d = u[0]; d--;) a = a.lastChild;
        ...
        for (p.textContent = "", m = 0; o = h[m++];)
            ...
            for (d = 0; o = a[d++];) He.test(o.type || "") && n.push(o);
        return p
    }
    ...
    function C(e, t, n, r) {
        ...
        var i, o, a, s, u, l, f = 0,
            ...
            m = t[0],
            g = oe.isFunction(m);
        if (g || p > 1 && "string" == typeof m && !re.checkClone && We.test(m)) return e.each(function(i) {
            var o = e.eq(i);
            g && (t[0] = m.call(this, i, o.html())), C(o, t, n, r)
        });
        if (p && (i = d(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            for (a = oe.map(c(i, "script"), y), s = a.length; p > f; f++) u = i, f !== h && (u = oe.clone(u, !0, !0), s && oe.merge(a, c(u, "script"))), n.call(e[f], u, f);
            if (s)
                for (l = a[a.length - 1].ownerDocument, oe.map(a, x), f = 0; s > f; f++) u = a[f], He.test(u.type || "") && !Ee.access(u, "globalEval") && oe.contains(l, u) && (u.src ? oe._evalUrl && oe._evalUrl(u.src) : oe.globalEval(u.textContent.replace(Xe, "")))
        }
        return e
    }
    ...
    function S(e, t, n) {
        ...
        return n = n || Ke(e), a = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== a && void 0 !== a || oe.contains(e.ownerDocument, e) || (a = oe.style(e, t)), n && !re.pixelMarginRight() && Ge.test(a) && Ye.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o), void 0 !== a ? a + "" : a
    }
    ...
    function D(t, n, r) {
        ...
        return o + I(t, n, r || (s ? "border" : "content"), i, a) + "px"
    }

    function L(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = Ee.get(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Le(r) && (o[a] = Ee.access(r, "olddisplay", E(r.nodeName)))) : (i = Le(r), "none" === n && i || Ee.set(r, "olddisplay", i ? n : oe.css(r, "display"))));
    ...
    function _(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = it || O(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++) l.tweens[a].run(o);
        ...
        for (F(c, l.opts.specialEasing); a > o; o++)
            if (r = _.prefilters[o].call(l, e, c, l.opts)) return oe.isFunction(r.stop) && (oe._queueHooks(l.elem, l.opts.queue).stop = oe.proxy(r.stop, r)), r;
        return oe.map(c, q, l), oe.isFunction(l.opts.start) && l.opts.start.call(e, l), oe.fx.timer(oe.extend(u, {
            elem: e,
            anim: l,
            queue: l.opts.queue
    ...
    function U(e, t, n, r) {
        ...
        if (oe.isArray(t)) oe.each(t, function(t, i) {
            n || It.test(e) ? r(e, i) : U(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
        });
    ...
    var ce = function(e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : B) !== L && D(t), t = t || L, O)) {
                if (11 !== m && (l = ve.exec(e)))
                    if (i = l[1]) {
                        if (9 === m) {
                ...
                if (w.qsa && !X[e + " "] && (!H || !H.test(e))) {
                    if (1 !== m) h = t, p = e;
                        ...
                        for ((s = t.getAttribute("id")) ? s = s.replace(xe, "\\$&") : t.setAttribute("id", s = _), f = E(e), o = f.length, u = de.test(s) ? "#" + s : "[id='" + s + "']"; o--;) f[o] = u + " " + d(f[o]);
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (a) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (l = t[_] || (t[_] = {}), u = l[t.uniqueID] || (l[t.uniqueID] = {}), (s = u[r]) && s[0] === R && s[1] === o) return c[2] = s[2];
        ...
        function v(e, t, n, i, o, a) {
            return i && !i[_] && (i = v(i)), o && !o[_] && (o = v(o, a)), r(function(r, a, s, u) {
                var l, c, f, d = [],
                    p = [],
                    h = a.length,
                ...
                } else x = g(x === a ? x.splice(h, x.length) : x), o ? o(null, a, x, u) : Q.apply(a, x)
            })
        }
            ...
            var i = n.length > 0,
                ...
                a = function(r, a, s, u, l) {
                    var c, f, d, p = 0,
                        ...
                        w = x.length;
                    for (l && (j = a === L || a || l); h !== w && null != (c = x[h]); h++) {
                        if (o && c) {
        ...
        var b, w, C, T, k, E, S, N, j, A, I, D, L, P, O, H, q, M, F, _ = "sizzle" + 1 * new Date,
            B = e.document,
            R = 0,
            z = 0,
            W = n(),
        ...
        try {
            Q.apply(G = J.call(B.childNodes), B.childNodes), G[B.childNodes.length].nodeType
        } catch (Te) {
            Q = {
        ...
        w = t.support = {}, k = t.isXML = function(e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, P = L.documentElement, O = !k(L), (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), w.attributes = i(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), w.getElementsByTagName = i(function(e) {
                return e.appendChild(L.createComment("")), !e.getElementsByTagName("*").length
            }), w.getElementsByClassName = ge.test(L.getElementsByClassName), w.getById = i(function(e) {
                return P.appendChild(e).id = _, !L.getElementsByName || !L.getElementsByName(_).length
            ...
            }, q = [], H = [], (w.qsa = ge.test(L.querySelectorAll)) && (i(function(e) {
                ...
                w.disconnectedMatch = M.call(e, "div"), M.call(e, "[s!='']:x"), q.push("!=", oe)
            }), H = H.length && new RegExp(H.join("|")), q = q.length && new RegExp(q.join("|")), t = ge.test(P.compareDocumentPosition), F = t || ge.test(P.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === B && F(B, e) ? -1 : t === L || t.ownerDocument === B && F(B, t) ? 1 : A ? ee(A, e) - ee(A, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return I = !0, 0;
                var n, r = 0,
                    i = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== L && D(e), n = n.replace(ce, "='$1']"), w.matchesSelector && O && !X[n + " "] && (!q || !q.test(n)) && (!H || !H.test(n))) try {
                var r = M.call(e, n);
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (d = g, f = d[_] || (d[_] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), l = c[e] || [], p = l[0] === R && l[1], x = p && l[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (x = p = 0) || h.pop();)
                                    if (1 === d.nodeType && ++x && d === t) {
                                        c[e] = [R, p, x];
                                        break
                                    }
                            } else if (y && (d = t, f = d[_] || (d[_] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), l = c[e] || [], p = l[0] === R && l[1], x = p), x === !1)
                                for (;
                                    (d = ++p && d && d[m] || (x = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++x || (y && (f = d[_] || (d[_] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), c[e] = [R, x]), d !== t)););
        ...
        return f.prototype = C.filters = C.pseudos, C.setFilters = new f, E = t.tokenize = function(e, n) {
            ...
            for (s = e, u = [], l = C.preFilter; s;) {
                ...
                for (a in C.filter) !(i = pe[a].exec(s)) || l[a] && !(i = l[a](i)) || (r = i.shift(), o.push({
                    value: r,
                    type: a,
                    matches: i
                }), s = s.slice(r.length));
            ...
            if (n = n || [], 1 === f.length) {
                if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === t.nodeType && O && C.relative[o[1].type]) {
                ...
                for (i = pe.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !C.relative[s = a.type]);)
                    if ((u = C.find[s]) && (r = u(a.matches[0].replace(be, we), ye.test(o[0].type) && c(t.parentNode) || t))) {
                        if (o.splice(i, 1), e = r.length && d(o), !e) return Q.apply(n, r), n;
                        break
                    }
            }
            return (l || S(e, f))(r, t, !O, n, !t || ye.test(e) && c(t.parentNode) || t), n
        }, w.sortStable = _.split("").sort(U).join("") === _, w.detectDuplicates = !!I, D(), w.sortDetached = i(function(e) {
    ...
    oe.Callbacks = function(e) {
            ...
            c = {
                ...
                remove: function() {
                    return oe.each(arguments, function(e, t) {
                        for (var n;
                            (n = oe.inArray(t, a, n)) > -1;) a.splice(n, 1), u >= n && u--
                    }), this
                },
                has: function(e) {
        ...
        when: function(e) {
            ...
            if (a > 1)
                for (t = new Array(a), n = new Array(a), r = new Array(a); a > i; i++) o[i] && oe.isFunction(o[i].promise) ? o[i].promise().progress(l(i, n, t)).done(l(i, r, o)).fail(u.reject) : --s;
    ...
    oe.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, u, l, c, f, d, p, h, m, g = Ee.get(e);
            if (g)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = oe.guid++), (u = g.events) || (u = g.events = {}), (a = g.handle) || (a = g.handle = function(t) {
                        return "undefined" != typeof oe && oe.event.triggered !== t.type ? oe.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(we) || [""], l = t.length; l--;) s = Be.exec(t[l]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p && (f = oe.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = oe.event.special[p] || {}, c = oe.extend({
                    type: p,
                    origType: m,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (d = u[p]) || (d = u[p] = [], d.delegateCount = 0, f.setup && f.setup.call(e, r, h, a) !== !1 || e.addEventListener && e.addEventListener(p, a)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, c) : d.push(c), oe.event.global[p] = !0)
        },
        remove: function(e, t, n, r, i) {
            var o, a, s, u, l, c, f, d, p, h, m, g = Ee.hasData(e) && Ee.get(e);
            if (g && (u = g.events)) {
                for (t = (t || "").match(we) || [""], l = t.length; l--;)
                    if (s = Be.exec(t[l]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
                        ...
                        a && !d.length && (f.teardown && f.teardown.call(e, h, g.handle) !== !1 || oe.removeEvent(e, p, g.handle), delete u[p])
                    } else
        ...
        fix: function(e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                a = this.fixHooks[i];
            for (a || (this.fixHooks[i] = a = _e.test(i) ? this.mouseHooks : Fe.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new oe.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    oe.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(re.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || oe.isXMLDoc(e)))
                for (a = c(s), o = c(e), r = 0, i = o.length; i > r; r++) w(o[r], a[r]);
            if (t)
                if (n)
                    for (o = o || c(e), a = a || c(s), r = 0, i = o.length; i > r; r++) b(o[r], a[r]);
                else b(e, s);
        ...
        html: function(e) {
            return Te(this, function(e) {
                ...
                if ("string" == typeof e && !ze.test(e) && !qe[(Oe.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = oe.camelCase(t),
                    u = e.style;
                return t = oe.cssProps[s] || (oe.cssProps[s] = j(s) || s), a = oe.cssHooks[t] || oe.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Ie.exec(n)) && i[1] && (n = l(e, t, i), o = "number"), void(null != n && n === n && ("number" === o && (n += i && i[3] || (oe.cssNumber[s] ? "" : "px")), re.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n))))
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = oe.camelCase(t);
            return t = oe.cssProps[s] || (oe.cssProps[s] = j(s) || s), a = oe.cssHooks[t] || oe.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = S(e, t, r)), "normal" === i && t in tt && (i = tt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
        }
    }), oe.each(["height", "width"], function(e, t) {
        oe.cssHooks[t] = {
            get: function(e, n, r) {
                return n ? Je.test(oe.css(e, "display")) && 0 === e.offsetWidth ? Ze(e, et, function() {
                    return D(e, t, r)
                }) : D(e, t, r) : void 0
            },
            set: function(e, n, r) {
                var i, o = r && Ke(e),
                    a = r && I(e, t, r, "border-box" === oe.css(e, "boxSizing", !1, o), o);
                return a && (i = Ie.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = oe.css(e, t)), A(e, n, a)
            }
        }
    }), oe.cssHooks.marginLeft = N(re.reliableMarginLeft, function(e, t) {
        return t ? (parseFloat(S(e, "marginLeft")) || e.getBoundingClientRect().left - Ze(e, {
            marginLeft: 0
        }, function() {
    ...
    oe.Animation = oe.extend(_, {
            tweeners: {
                "*": [function(e, t) {
                    ...
                    return l(n.elem, e, Ie.exec(t), n), n
                }]
            },
        ...
        addClass: function(e) {
            ...
            if ("string" == typeof e && e)
                for (t = e.match(we) || []; n = this[u++];)
                    if (i = B(n), r = 1 === n.nodeType && (" " + i + " ").replace(dt, " ")) {
    ...
    oe.extend(oe.event, {
        trigger: function(t, n, r, i) {
            var o, a, s, u, l, c, f, d = [r || G],
                p = ne.call(t, "type") ? t.type : t,
                h = ne.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = s = r = r || G, 3 !== r.nodeType && 8 !== r.nodeType && !mt.test(p + oe.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, t = t[oe.expando] ? t : new oe.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[p] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !oe.isWindow(r)) {
                    for (u = f.delegateType || p, mt.test(u + p) || (a = a.parentNode); a; a = a.parentNode) d.push(a), s = a;
                ...
                return t.type = p, i || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !ke(r) || l && oe.isFunction(r[p]) && !oe.isWindow(r) && (s = r[l], s && (r[l] = null), oe.event.triggered = p, r[p](), oe.event.triggered = void 0, s && (r[l] = s)), t.result
            }
        },
    ...
    jt.href = gt.href, oe.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, s) {
                var l, f, y, x, w, T = n;
                2 !== b && (b = 2, u && e.clearTimeout(u), i = void 0, a = s || "", C.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, r && (x = $(d, C, r)), x = X(d, x, C, l), l ? (d.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (oe.lastModified[o] = w), w = C.getResponseHeader("etag"), w && (oe.etag[o] = w)), 204 === t || "HEAD" === d.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = x.state, f = x.data, y = x.error, l = !y)) : (y = T, !t && T || (T = "error", 0 > t && (t = 0))), C.status = t, C.statusText = (n || T) + "", l ? m.resolveWith(p, [f, T, C]) : m.rejectWith(p, [C, T, y]), C.statusCode(v), v = void 0, c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [C, d, l ? f : y]), g.fireWith(p, [C, T]), c && (h.trigger("ajaxComplete", [C, d]), --oe.active || oe.event.trigger("ajaxStop")))
            }
            ...
            if (m.promise(C).complete = g.add, C.success = C.done, C.error = C.fail, d.url = ((t || d.url || gt.href) + "").replace(xt, "").replace(kt, gt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = oe.trim(d.dataType || "*").toLowerCase().match(we) || [""], null == d.crossDomain) {
                l = G.createElement("a");
                try {
            ...
            if (d.data && d.processData && "string" != typeof d.data && (d.data = oe.param(d.data, d.traditional)), z(Et, d, n, C), 2 === b) return C;
    ...
    oe.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !oe(this).is(":disabled") && Pt.test(this.nodeName) && !Lt.test(e) && (this.checked || !Pe.test(e))
            }).map(function(e, t) {
                var n = oe(this).val();
    ...
    re.cors = !!Ht && "withCredentials" in Ht, re.ajax = Ht = !!Ht, oe.ajaxTransport(function(t) {
        var n, r;
        return re.cors || Ht && !t.crossDomain ? {
            send: function(i, o) {
                var a, s = t.xhr();
    ...
    oe.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = qt.pop() || oe.expando + "_" + vt++;
            return this[e] = !0, e
        }
    }), oe.ajaxPrefilter("json jsonp", function(t, n, r) {
        var i, o, a, s = t.jsonp !== !1 && (Mt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Mt.test(t.data) && "data");
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Mt, "$1" + i) : t.jsonp !== !1 && (t.url += (yt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
    ...
    oe.fn.load = function(e, t, n) {
        ...
        setOffset: function(e, t, n) {
            var r, i, o, a, s, u, l, c = oe.css(e, "position"),
                f = oe(e),
                d = {};
            "static" === c && (e.style.position = "relative"), s = f.offset(), o = oe.css(e, "top"), u = oe.css(e, "left"), l = ("absolute" === c || "fixed" === c) && (o + u).indexOf("auto") > -1, l ? (r = f.position(), a = r.top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), oe.isFunction(t) && (t = t.call(e, n, oe.extend({}, s))), null != t.top && (d.top = t.top - s.top + a), null != t.left && (d.left = t.left - s.left + i), "using" in t ? t.using.call(e, d) : f.css(d)
        }
    }, oe.fn.extend({
        offset: function(e) {
    ...
    return oe.noConflict = function(t) {
        return e.$ === oe && (e.$ = Bt), t && e.jQuery === oe && (e.jQuery = _t), oe
    }, t || (e.jQuery = e.$ = oe), oe
}), ! function(e) {
    "use strict";
...
function(e) {
    ...
    x.prototype = {
        ...
        open: function(n) {
            ...
            }, 16), t.isOpen = !0, t.updateSize(c), k(d), n
        },
        close: function() {
            t.isOpen && (k(u), t.isOpen = !1, t.st.removalDelay && !t.isLowIE && t.supportsTransition ? (t._addClassToMFP(v), setTimeout(function() {
                t._close()
        ...
        appendContent: function(e, n) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && t.currTemplate[n] === !0 ? t.content.find(".mfp-close").length || t.content.append(E()) : t.content = e : t.content = "", k(c), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(n) {
            var r, i = t.items[n];
            if (i.tagName ? i = {
        ...
        _parseMarkup: function(t, n, r) {
            var i;
            r.data && (n = e.extend(r.data, n)), k(f, [t, n, r]), e.each(n, function(n, r) {
    ...
    var j, A, I, D = "inline",
        L = function() {
            I && (A.after(I.addClass(j)).detach(), I = null)
        };
            ...
            getInline: function(n, r) {
                if (L(), n.src) {
                    ...
                    if (o.length) {
                        ...
                        a && a.tagName && (A || (j = i.hiddenClass, A = T(j), j = "mfp-" + j), I = o.after(A).detach().removeClass(j)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(O, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(O), P = t.st.ajax.cursor, C(s + "." + O, q), C("BeforeChange." + O, q)
            },
            getAjax: function(n) {
                ...
                var r = e.extend({
                    ...
                    success: function(r, i, o) {
                        ...
                        k("ParseAjax", a), t.appendContent(e(a.data), O), n.finished = !0, H(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(g)
        ...
        proto: {
                ...
                var n = 0,
                    ...
                    i = function(o) {
                        M && clearInterval(M), M = setInterval(function() {
                            return r.naturalWidth > 0 ? void t._onImageHasSize(e) : (n > 200 && clearInterval(M), n++, 3 === n ? i(10) : 40 === n ? i(50) : 100 === n && i(500), void 0)
                        }, o)
                    };
                i(1)
            },
            getImage: function(n, r) {
                ...
                if (u.length) {
                    ...
                    l.className = "mfp-img", n.el && n.el.find("img").length && (l.alt = n.el.find("img").attr("alt")), n.img = e(l).on("load.mfploader", o).on("error.mfploader", a), l.src = n.src, u.is("img") && (n.img = n.img.clone()), l = n.img[0], l.naturalWidth > 0 ? n.hasSize = !0 : l.width || (n.hasSize = !1)
                }
                ...
                if (n.enabled && t.supportsTransition) {
                    ...
                    C("BuildControls" + r, function() {
                        if (t._allowZoom()) {
                            ...
                            o = l(e), o.css(t._getOffset()), t.wrap.append(o), i = setTimeout(function() {
...
}), $("a[href$='.jpg'],a[href$='.jpeg'],a[href$='.JPG'],a[href$='.png'],a[href$='.gif']").addClass("image-popup"), $(function() {
    $(".content").fitVids()
}), $(".projects-menu-icon").click(function() {
    $("html").toggleClass("no-scroll"), $(this).toggleClass("active"), $(".overlay").toggleClass("show")
}), $(".everydays-menu-icon").click(function() {
    $("html").toggleClass("no-scroll"), $(this).toggleClass("active"), $(".overlay2").toggleClass("show")
